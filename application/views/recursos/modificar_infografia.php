...
<div class="card mx-auto" style="width: 50%; text-align: center;">
    <div class="card-body">
        <form enctype="multipart/form-data" method="POST" action="<?php echo base_url('recursos/modificar_infografia');  ?>">
            ...
            <?php if ($arxiu == null) { ?>
                <img style="width: 20%;" src="<?php echo base_url('assets/img/no-imatge.png'); ?>" class="card-img-top">
                <br><br>
            <?php } else { ?>
                <table class="table text-center">
                    <thead>
                    ...
                    <tbody>
                        <tr>
                            <td><img style="width: 20%;" src="<?php echo base_url('recurs/' . $id_recurs); ?>" class="card-img-top" alt="<?php echo $arxiu['nom_original']; ?>"></td>
                            <td><a class="btn btn-outline-danger" href="<?php echo base_url('recurs/infografia/borrar/' . $id_recurs) ?>"><i class="fas fa-times"></i>&nbsp;Borrar</a></td>
                        </tr>
                    </tbody>
                </table>
                <?php } ?>
                <table class="table text-center">
                    ...
                    <tbody>
                        <tr>
                            <td><input class="infile" type="file" name="arxiu" id="arxiu" size="20" /></td>
                        </tr>
                    </tbody>
                </table>
                <table class="table text-center">
                    ...
                    <tbody>
                        <?php foreach ($adjunts as $adjunts_item) : ?>
                            <tr>
                                ...
                                <td><a class="btn btn-outline-danger" href="<?php echo base_url('recurs/infografia/borrar/arxius/' . $id_recurs  . '/adjunts/' . $adjunts_item['id']); ?>"><i class="fas fa-times"></i>&nbsp;Borrar</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
