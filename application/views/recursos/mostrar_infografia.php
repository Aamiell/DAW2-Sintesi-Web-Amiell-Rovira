<div class="card mx-auto" style="width: 50%; text-align: center;">
    <img src="<?php echo base_url('recurs/' . $id_recurs); ?>" class="card-img-top" alt="<?php echo $arxiu['nom_original']; ?>">
    ...
    <div class="card-body">
        ...
        <ul class="list-group list-group-flush">
            <?php foreach ($adjunts as $adjunts_item) : ?>
                <li class="list-group-item"><?php echo $adjunts_item['nom_original']; ?></li><a style="width: 100%;" class="btn btn-outline-info" href="<?php echo base_url('recurs/arxius/' . $id_recurs  .'/adjunts/'. $adjunts_item['id']); ?>"><i class="fas fa-download"></i>&nbsp;Descargar</a>
            <?php endforeach; ?>
        </ul>
    </div>
</div>