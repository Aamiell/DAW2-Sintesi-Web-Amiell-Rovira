                        ...
                        <div class="col-lg-7">
                            ...
                            <div style="margin-left: 71%;  margin-top: -7%">
                                ...
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4"><i class="fas fa-video"></i>&nbsp;Video</h1>
                                </div>
                                <script>
                                    tinymce.init({
                                        selector: '#explicacio',
                                ...
                                <form class="user" action="<?php echo base_url('recurs/video') ?>" enctype="multipart/form-data" method="POST">
                                    <b>Arxiu recurs: </b>
                                    <br>
